...
namespace eClinicals.Controllers
{
    class eClinicalsController
    {
        ...
        public Visit CreateCheckup(int appointmentID, int nurseID, int systolicBP, int diastolicBP, decimal bodyTemp, int pulse, int symptomID)
        {
            return DAL.VisitDAL.CreateCheckup(appointmentID, nurseID, systolicBP, diastolicBP, bodyTemp, pulse, symptomID);
        }
